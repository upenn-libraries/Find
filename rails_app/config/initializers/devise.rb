...
require 'omni_auth/strategies/alma'
...
Devise.setup do |config|
  ...
  config.omniauth :saml, {
    ...
    # https://www.isc.upenn.edu/how-to/shibboleth-attributes-available-penn
    attribute_statements: { uid: ['urn:oid:1.3.6.1.4.1.5923.1.1.1.6'], # pennkey@upenn.edu
                            # directory (or pennname@upenn.edu) email, unless blocked
