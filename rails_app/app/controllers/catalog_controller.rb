...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_sort_field 'call_num_sort asc, title_sort asc', label: I18n.t('sort.call_num_asc')
    config.add_sort_field 'call_num_sort desc, title_sort asc', label: I18n.t('sort.call_num_desc')
