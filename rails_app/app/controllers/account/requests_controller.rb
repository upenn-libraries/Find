...
module Account
  ...
  class RequestsController < AccountController
    ...
    def renew_all
      ...
      # @note when a large amount of loans are renewed, the length of the alert content can lead to a cookie
