  ...
  class Source
    ...
    class Libraries < Source
      ...
      def body_from(record:)
        [record.dig('attributes', 'creator_ss', 'attributes', 'value'),
         record.dig('attributes', 'format_facet', 'attributes', 'value')]
      end
