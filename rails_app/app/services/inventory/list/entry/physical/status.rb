        ...
        class Status
          ...
          def status_keys
            @status_keys ||= case status
                             ...
                             when Constants::CHECK_HOLDINGS then [Constants::CHECK_HOLDINGS_KEY,
                                                                  policy.check_holdings_status_key]
                             when Constants::UNAVAILABLE then [Constants::UNAVAILABLE_KEY,
                                                               policy.unavailable_status_key].compact
                             end
          end
