...
class QueryConfigs
  class << self
    ...
    def keyword_config_fields_qf
      %w[mmsid^100000 doi_ss^10000 oclc_id_ss^10000 isxn_search^8000 call_number_search^5000
         ...
         creator_unstem_search^700 creator_aux_unstem_search^500 conference_unstem_search^500 conference_search^300
         subject_unstem_search^750 subject_search^600 genre_unstem_search^650 genre_search^500
         marcxml_marcxml]
    end

    def keyword_config_fields_pf
      %w[title_anchored_search^12000 title_unstem_search^10000 title_search^5000
         ...
         creator_unstem_search^2000 creator_aux_unstem_search^500 conference_unstem_search^500 conference_search^75
         subject_unstem_search^2000 subject_search^150 genre_unstem_search^1000 genre_search^150
         marcxml_marcxml^100]
    end

    def keyword_config_fields_pf2
      %w[title_anchored_search^50000 title_unstem_search^30000 title_search^10000
         ...
         creator_unstem_search^4500 creator_aux_unstem_search^2000]
    end

    def keyword_config_fields_pf3
      %w[title_anchored_search^80000 title_unstem_search^60000 title_search^15000
         ...
         creator_unstem_search^7000 creator_aux_unstem_search^4000]
    end
  end
end
