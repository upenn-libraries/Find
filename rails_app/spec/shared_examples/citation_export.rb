...
shared_examples_for 'CitationExport' do
  ...
  describe '#export_as_mla_citation_txt' do
    ...
    context 'with a print monograph record' do
      ...
      it 'returns MLA citation text' do
        value = object.export_as_mla_citation_txt
        expect(value).to eq('Bleier, Ruth. <i>The hypothalamus of the cat; a cytoarchitectonic atlas in the ' \
                            'Horsley-Clarke co-ordinate system. </i>Baltimore : John Hopkins Press, [1961]')
      end
    end
  end
  ...
  describe '#export_as_apa_citation_txt' do
    ...
    context 'with a print monograph record' do
      ...
      it 'returns APA citation text' do
        value = object.export_as_apa_citation_txt
        expect(value).to eq('Bleier, R. (1961). <i>The hypothalamus of the cat; a cytoarchitectonic atlas in the ' \
                            'Horsley-Clarke co-ordinate system. </i>Baltimore : John Hopkins Press.')
      end
    end
  end
