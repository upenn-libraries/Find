...
describe Library::Info::Request do
  ...
  describe '.find' do
    context 'with a successful api request and library data' do
    ...
    context 'with a successful api request but no available library data' do
      before { stub_library_info_api_request_success(library_code: code, response_body: []) }
